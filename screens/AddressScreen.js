...
const dataAddress = [
    {
      ...
      description:
        "22C/1/2A, Tổ 7, KP3, P.10, Quận 13, TP. Hồ Chí Minh",
    },
    {
      id: 2,
      title: "Lê Anh Kiệt | 0905078138",
    ...
    },
    {
      ...
      title: "Lê Anh Kiệt | 0905078138",
      description:
      "Đường Võ Văn Kiệt, P. Bến Nghé, Quận 12, TP. Hồ Chí Minh",
    },
  ];
const AddressScreen = () => {
  return (
    ...
    <FlatList
      ...
      ListFooterComponent={()=>(
        <View style={{paddingVertical: 20, alignItems: 'center', flexDirection: 'row', justifyContent: 'center'}}>
            <Ionicons name="add-circle-outline" size={24} color={"grey"} />
            <Text style={{fontSize: 16, color: 'grey'}}>{" "}Thêm địa chỉ mới</Text>
        </View>
      )}
    />
